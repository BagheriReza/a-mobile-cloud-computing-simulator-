...
public class TaskStage {
	...
	public TaskStage(int type, double data, double time, double stageid, long memory, int peer, int vpeer, ArrayList<Integer> VMtoCloudletEnergy) {
		super();
		this.type = type;
		this.data = data;
		this.time = time;
	...
	ArrayList<Integer> VMtoCloudletEnergy = new ArrayList<Integer>();  // Total time basde on each VM BW
