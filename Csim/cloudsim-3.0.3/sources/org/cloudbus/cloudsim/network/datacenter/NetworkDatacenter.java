...
public class NetworkDatacenter extends Datacenter {
	...
	public NetworkDatacenter(
		...
		super(name, characteristics, vmAllocationPolicy, storageList,cl, schedulingInterval);
	 ...
	 * 
	 */
	public boolean processVmCreateNetwork(Vm vm, NetworkDatacenter Networkdatacenter) {
	...
	protected void processCloudletSubmit(SimEvent ev, boolean ack) {
		...
		try {
			...
			// added and change by reza
			// time to transfer the files
			Log.printLine(" cloudlet ID: "+ cl.getCloudletId()+" need to read file name: "+ cl.getRequiredFiles());
			double fileTransferTime = 0.0;//predictFileTransferTime(cl.getRequiredFiles(),cl,vm);
			//Log.printLine(" transfer time ="+ fileTransferTime);
