...
public class Vm {
	...
	// added by reza
	/** BDMCC: The battery. */
	public int NoMigCuncurent =0;
	private long battery;
	public boolean migrate = false ;
	/** BDMCC: The amount of energy for processing cloudlet on VM per time unit. */
	public ArrayList<Double> EnrgyPerTimeUnit = new ArrayList<Double>(); 
	...
	private long currentAllocatedbattery;
	...
	//addeed by reza
	public int finish =0;
	public double ExeE =0;
	public double TransE =0;
	public double ReadE =0;
	public double ReplicaManagmentE =0;
	 ...
	 * @post $none
	 */
	public double updateVmProcessing(double currentTime, List<Double> mipsShare, Datacenter networkdatacenter) {
		if (mipsShare != null) {
			return getCloudletScheduler().updateVmProcessing(currentTime, mipsShare, this.getId(), networkdatacenter);
		}
		return 0.0;
	}
	...
	public ArrayList<Double> getEnrgyPerTimeUnit() {
		return EnrgyPerTimeUnit;
	}
	/**
	...
	public void setbattery(long battery2) {
		//Log.printLine();
        //Log.printLine("========== Reza ==================== VM" + this.id + "'s battery is : " + battery2);
		this.battery = battery2;
	}
	
	public void setEnrgyPerTimeUnit(ArrayList<Double> EnrgyPerTimeUnit) {
		this.EnrgyPerTimeUnit = EnrgyPerTimeUnit;
	}
	...
	public long getCurrentAllocatedbattery() {
		
		return currentAllocatedbattery;
	}
	/**
	...
	protected void setCurrentAllocatedbattery(long currentAllocatedbattery) {
		
        
		this.currentAllocatedbattery = currentAllocatedbattery;
	}
	/**
	...
	//// added by reza
	///////////////////////////////////////////////////////////
	public double getReplicaManagmentE() {
		return ReplicaManagmentE;
	}
	public void AddReplicaManagmentE(double E) {
		this.ReplicaManagmentE = this.ReplicaManagmentE + E;
	}
	///////////////////////////////////////////////////////////////
	public double getExeE() {
		return ExeE;
	}
	public void AddExeE(double E) {
		this.ExeE = this.ExeE + E;
	}
	//////////////////////////////////////////////////////////////////////////////////
	
	public double getTransE() {
		return TransE;
	}
	public void AddTransE(double E) {
		this.TransE = this.TransE + E;
	}
	///////////////////////////////////////////////////////////////////////////////////
	public double getReadE() {
		return ReadE;
	}
	public void AddReadE(double E) {
		this.ReadE = this.ReadE + E;
	}
	/**
