...
public class ResCloudlet {
	 ...
	 * @post $result >= 0
	 */
	public long getRemainingCloudletLength(double VmMIPS) {
		long length = (long) ((cloudlet.getCloudletTotalLength()+ (cloudlet.getReadDelay()*VmMIPS))* Consts.MILLION - cloudletFinishedSoFar); //= cloudlet.getCloudletTotalLength() * Consts.MILLION - cloudletFinishedSoFar;
		//Log.printLine("CloudletId: "+ cloudlet.getCloudletId()+" VmID: "+ cloudlet.getVmId()+" TotalLength: "+cloudlet.getCloudletTotalLength()+" ReadDelay(): "+  cloudlet.getReadDelay()
		//	+ " VmMIPS: "+VmMIPS+ " cloudletFinishedSoFar: " +cloudletFinishedSoFar);
