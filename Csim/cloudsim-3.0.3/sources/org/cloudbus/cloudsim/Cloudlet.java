...
public class Cloudlet {
	...
	//added by reza
	private boolean ReadCalDone = false;
	private boolean ReadCalDelayOneTime = false;
	public double ReadDelay = 0.0;
	public double ReadDelayForEnergyDeductionPassing;
	private long ReadEnergy = 0;
	private long WriteDelay;
	private long WriteEnergy;
	private long TransDelay=0;;
	private long TransEnergy=0;;
	private double ExecutionEnergy = 0;
	private boolean FileForWrite;
	public long OrginalLength;	
	...
	private final long cloudletcharge;
	...
	private List<File> CreateFile = null;
	public ArrayList<Integer> VMtoCloudletEnergy = null; 
	public ArrayList<Integer> VMtoCloudletTime = null; 
	public boolean migrated = false;
	public boolean migrateIsDone = false;
	public int OrginalVmID;
	public int PreVMID;
	public double ProgressPersentage = 0.0;
	public int AppNum;
	...
	public Cloudlet(
		...
		CreateFile = new LinkedList<File>(); // added by reza
		VMtoCloudletEnergy = new ArrayList<Integer>(); // added by reza
		VMtoCloudletTime = new ArrayList<Integer>(); // added by reza
	}
	...
	public Cloudlet(
			...
			final List<File> writefile,
			final ArrayList<Integer> VMtoCloudletEnergyt,
			final ArrayList<Integer> VMtoCloudletTimet) {
		this(
				cloudletId,
				cloudletLength,
				pesNumber,
		...
		VMtoCloudletEnergy = VMtoCloudletEnergyt;
		VMtoCloudletTime = VMtoCloudletTimet;
	}
	...
	public Cloudlet(
		...
		this.cloudletcharge = Math.max(1, cloudletcharge);
		...
		requiredFiles = new LinkedList<String>();
		CreateFile = new LinkedList<File>();
		VMtoCloudletEnergy = new ArrayList<Integer>();
		VMtoCloudletTime = new ArrayList<Integer>();
	...
	public long getCloudletcharge() {
		return cloudletcharge;
	}
	/**
	...
	/**
	 * Added By Reza, Gets Delay of read for all files
	 * 
	 * @return the read delay of this Cloudlet for all files 
	 * @pre $none
	 * @post $result >= 0.0
	 */
	...
	/**
	 * Added By Reza, Sets Delay of read for all files
	 * 
	 * @return $none
	 * @pre Read delay of files
	 * @post $result >= 0.0
	 */
	public void SetReadDelay(double delay) {
		ReadDelay = delay;
	}
	
	public void setReadCalDone(boolean state) {
		ReadCalDone = state;
	}
	public boolean getReadCalDone() {
		return ReadCalDone;
	}
	
	public void setReadCalDelayOneTime() {
		ReadCalDelayOneTime = true;
	}
	public boolean getReadCalDelayOneTime() {
		return ReadCalDelayOneTime;
	}
	/**
	 * Added By Reza, get Delay of write for all files
	 * 
	 * @return the write delay of this Cloudlet for all files 
	 * @pre $none
	 * @post $result >= 0.0
	 */
	...
	/**
	 * Added By Reza, Sets Delay of write for all files
	 * 
	 * @return $none
	 * @pre write delay of files
	 * @post $result >= 0.0
	 */
	public void SetWriteDelay(long delay) {
		WriteDelay = delay;
	}
	
	
	public long getReadEnergy() {
		return ReadEnergy;
	}
	
	public void SetReadEnergy(long Energy) {
		ReadEnergy = Energy;
	}
	
	public void AddReadEnergy(long Energy) {
		ReadEnergy = ReadEnergy + Energy;
	}
	
	public long getWriteEnergy() {
		return WriteEnergy;
	}
	
	public void SetWriteEnergy(long Energy) {
		WriteEnergy = Energy;
	}
	...
	public void SetTransEnergy(long Energy) {
		TransEnergy = TransEnergy+Energy;
	}
	
	
	public long getTransEnergy() {
		return TransEnergy;
	}
	
	public void SetTransDelay(long Delay) {
		TransDelay = TransDelay+Delay;
	}
	...
	public void setExecutionEnergy(double ExeE) {
		 ExecutionEnergy =ExeE ;
	}
	
	public void AddExecutionEnergy(double exeEnergy) {
		ExecutionEnergy = ExecutionEnergy+ exeEnergy;
	}
	...
	/** Added By Reza
	 * this is for set and get file need to be create for this cloudlet
	 */
	public List<File> getCreateFile() {
		this.FileForWrite = false;
		return CreateFile;
	}
	
	public void setCreateFile(final List<File> CreateFile) {
		
		if(!(CreateFile.isEmpty() )){
		this.CreateFile = CreateFile;
		this.FileForWrite = true;
		}
	}
	
	public boolean getFileForWrite() {
		
		return this.FileForWrite;
	}
	
public void setExeEnergy(ArrayList<Integer> VMtoCloudletEnergy) { //added by reza
		
		this.VMtoCloudletEnergy = VMtoCloudletEnergy;
	}
public void setExeTime(ArrayList<Integer> VMtoCloudletTimew) { //added by reza
	
	this.VMtoCloudletTime = VMtoCloudletTimew;
}
	/**
