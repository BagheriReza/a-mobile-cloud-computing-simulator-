...
public abstract class CloudletScheduler {
	 ...
	 * @post $none
	 */
	public abstract double updateVmProcessing(double currentTime, List<Double> mipsShare, int VMID, Datacenter networkdatacenter);
	 ...
	 * @post $none
	 */
	public abstract double cloudletSubmit(Cloudlet gl, double fileTransferTime,Datacenter datacenter);
	 ...
	 * @post $none
	 */
	public abstract double cloudletSubmit(Cloudlet gl,Datacenter datacenter);
	 ...
	 * @post $none
	 */
	public abstract Cloudlet migrateCloudlet(int CLID);
